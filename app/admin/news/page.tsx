    ...
    try {
      const res = await fetch('/api/news', {
        ...
        body: JSON.stringify({
          ...
          author: formAuthor,
          featured_image: formImage || undefined,
        }),
      });
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2">
        <div>
          ...
          <p className="text-sm text-[#6B7280]">
            Publish civic announcements, manage local breaking news, and curate editorial features
          </p>
        </div>
                  ...
                  <td colSpan={5} className="text-center py-12">
                    <div className="space-y-2">
                      ...
                      <p className="text-[#9CA3AF] text-xs">
                        Click &quot;Write New Article&quot; to publish the first city news update.
                      </p>
                    </div>
                  </td>
                </tr>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[11px] text-[#6B7280]">
                            {n.news_categories?.name || 'General'}
                          </p>
                        </div>
                      </div>
                    </td>
                    <td className="py-4 px-4 text-[#4B5563] font-medium">
                      {n.profiles?.full_name || n.author || 'Editorial Team'}
                    </td>
          ...
          <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto p-6 bg-white rounded-3xl shadow-2xl space-y-5">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-[#6B7280] hover:bg-[#F3F4F6] p-1.5 rounded-full"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="p-3 rounded-xl bg-blue-50 border border-blue-200 text-xs text-[#2563EB] font-semibold">
              Once published, this article immediately appears in the &quot;Today in Kozhikode&quot; section
              on the homepage.
            </div>
            ...
            <form onSubmit={handlePublishArticle} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-[#4B5563] uppercase tracking-wider">
                  Short Summary (shown in timeline)
                </label>
                <input
                  type="text"
                  value={formSummary}
